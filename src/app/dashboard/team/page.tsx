    ...
    >
      {!hasPersonalLinks && !hasTeamLinks && !hasMemberships ? (
        ...
        <div className="space-y-8">
          {/* Header with Meetings link */}
          <div className="flex items-center justify-between">
            <h1 className="text-3xl font-bold text-gray-900">Team</h1>
            <Link
              href="/dashboard/team/meetings"
              className="px-4 py-2 bg-[#0D7377] text-white rounded-lg hover:bg-[#0a5f63] text-sm font-medium transition-colors"
            >
              📅 Meetings
            </Link>
          </div>
